  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        nav: { DEFAULT: "hsl(var(--nav-bg))", foreground: "hsl(var(--nav-foreground))" },
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 5px hsl(var(--primary) / 0.3)" }, "50%": { boxShadow: "0 0 20px hsl(var(--primary) / 0.6)" } },
      },
      animation: {
